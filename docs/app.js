...
function renderDate() {
    ...
    if (newsletterData.date && dateContainer) {
        ...
        dateContainer.innerHTML += `<svg width="322" height="271" viewBox="0 0 322 271" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M160.824 121.503C188.888 121.503 213.956 129.875 231.805 142.992C249.658 156.112 259.824 173.539 259.824 192.003C259.824 210.468 249.658 227.895 231.805 241.015C213.956 254.132 188.888 262.503 160.824 262.503C132.76 262.503 107.692 254.132 89.8436 241.015C71.9905 227.895 61.8241 210.468 61.8241 192.003C61.8241 173.539 71.9905 156.112 89.8436 142.992C107.692 129.875 132.76 121.503 160.824 121.503Z" stroke="#F51E9F" stroke-opacity="0.803922" stroke-width="17"/>
            <ellipse cx="160.824" cy="192.003" rx="46.5" ry="34" fill="#F51E9F" fill-opacity="0.803922"/>
            <path d="M38.3241 140.503C7.82406 106.503 9.32406 63.0033 15.8241 41.0033" stroke="#F51E9F" stroke-opacity="0.803922" stroke-width="24" stroke-linecap="round"/>
            <path d="M157.659 90.5033C157.659 54.5033 161.324 34.5033 169.324 12.0033" stroke="#F51E9F" stroke-opacity="0.803922" stroke-width="24" stroke-linecap="round"/>
            <path d="M283.324 157.503C313.824 123.503 312.324 80.0033 305.824 58.0033" stroke="#F51E9F" stroke-opacity="0.803922" stroke-width="24" stroke-linecap="round"/>
            </svg>`;
    }
}
